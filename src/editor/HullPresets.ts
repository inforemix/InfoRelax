...
export const HULL_CATEGORIES = {
  racing: { label: 'Racing', icon: '🏁', color: '#EF4444' },
  cruising: { label: 'Cruising', icon: '⛵', color: '#3B82F6' },
  expedition: { label: 'Expedition', icon: '🧭', color: '#10B981' },
  luxury: { label: 'Luxury', icon: '💎', color: '#8B5CF6' },
  workboat: { label: 'Workboat', icon: '🔧', color: '#F59E0B' },
